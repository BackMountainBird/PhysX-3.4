...
namespace Gu { class HeightField; };
...
//	PX_INLINE		PxU32						computeCellCoordinates(PxReal x, PxReal z, PxU32 nbColumns, PxReal& fracX, PxReal& fracZ) const;
	...
	PX_FORCE_INLINE
	PX_CUDA_CALLABLE const PxHeightFieldSample&	getSample(PxU32 vertexIndex) const override
												{
...
private:
					...
					friend void physx::cloneHeightField(Gu::HeightField* clone, Gu::HeightField* orig);
};
