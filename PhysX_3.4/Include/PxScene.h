...
class PxScene
{
	...
	*/
	...
	/**
	\brief Get all rigidbodies's shape in to the scene's render buffer

	\note Do not use this method while the simulation is running. Calls to this method while result in undefined behaviour.

	\param[in] cullingBox The culling box for visualization

	@see PxRenderBuffer
	*/
	virtual void getVisualizationForDebug() = 0;
